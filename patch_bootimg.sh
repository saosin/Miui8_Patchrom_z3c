...
## DISABLE INIT_VENDOR use ini_sony linked init and ini.real

# ramdisk init binary from miui ? or vendor ? init.real at sony ?
...
## COPY MIUI PREPARED OVERLAY FOR RAMDISK CM13
